...
export default function Report1Page() {
  ...
  return (
    <div className='bg-white dark:bg-gray-800 shadow rounded-lg p-6'>
      ...
      {report.description && <p className='text-gray-600 dark:text-gray-300 mb-6'>{report.description}</p>}
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        {report.data.customerGrowth !== undefined && (
          <div className='bg-gray-100 dark:bg-gray-700 p-4 rounded-md'>
            ...
            <p className='text-3xl font-bold text-green-600 dark:text-green-400 mb-2'>{report.data.customerGrowth}%</p>
